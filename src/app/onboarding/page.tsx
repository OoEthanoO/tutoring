      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-16">
        ...
        <div className="w-full rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8">
          <form className="space-y-4" onSubmit={onSubmit}>
            ...
            {status ? (
              <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-xs text-emerald-800 dark:border-emerald-900/50 dark:bg-emerald-950/30 dark:text-emerald-400">
                {status}
              </div>
            ) : null}
            <button
